...
export default function Home() {
  ...
  return <main>
    ...
    <footer><div><span>Built by</span><img className="studio-credit-mark" src="/brand/compound-labs.svg" alt="Compound Labs" width={80} height={80} /></div><span>© 2026 leakless. A Compound Labs product.</span><a href="mailto:hello@thecompound.tech">hello@thecompound.tech</a></footer>
  </main>;
}
